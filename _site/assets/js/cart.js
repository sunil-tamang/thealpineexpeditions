	...
	app.createProducts = function(productName){
		...
		var products = [
			...
			},
			{
				...
				price : 1100.00,
				prodType :    'trekking',
				descShort :   ' Pikey Peak is a hidden gem in the Solu region of Nepal, known for its breathtaking views of Everest, Kanchenjunga, and several other Himalayan giants. This trek is perfect for those seeking a short, relatively easy adventure with stunning vistas. Below is a suggested 8-day itinerary for the Pikey Peak trek: ',
				descPartOne : ' Pikey Peak is a hidden gem in the Solu region of Nepal, known for its breathtaking views of Everest, Kanchenjunga, and several other Himalayan giants. This trek is perfect for those seeking a short, relatively easy adventure with stunning vistas. Below is a suggested 8-day itinerary for the Pikey Peak trek: ',
				descPartTwo : ' Pikey Peak is a hidden gem in the Solu region of Nepal, known for its breathtaking views of Everest, Kanchenjunga, and several other Himalayan giants. This trek is perfect for those seeking a short, relatively easy adventure with stunning vistas. Below is a suggested 8-day itinerary for the Pikey Peak trek: ',
				stock : 1,
				days : 8,
				nights: 7,
