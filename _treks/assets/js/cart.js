...
//			},
		...
		for(var i = lowerLimit; i <= upperLimit; i++){
			...
			// Treks
			else if((upperLimit >= 4)&&(upperLimit<=35)){
				if(products[i].stock > 0){
			...
			// Camping
			else if((upperLimit >= 36)&&(upperLimit<=37)){
				if(products[i].stock > 0){
					content+= '<div class="wrapper col-medium" data-aos="zoom-in" data-aos-easing="ease-in-out-quad">'
...
//					content+= '</div>'
			...
			// Escape Trips
			else if((upperLimit >= 38)&&(upperLimit<=44)){
				if(products[i].stock > 0){
...
//					content+= '</div>'
			...
			// Bike-Tours
			else if((upperLimit >= 45)&&(upperLimit<=46)){
				if(products[i].stock > 0){
			...
			// Mountain Bike-Tours
			else if((upperLimit >= 47)&&(upperLimit<=48)){
				if(products[i].stock > 0){
